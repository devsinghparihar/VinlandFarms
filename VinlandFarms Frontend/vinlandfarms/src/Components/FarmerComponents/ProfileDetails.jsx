...
import './ProfileDetails.css'; // Make sure the CSS file name matches the component name
          ...
          <div className="row">
            <div className="col-md-3 border-right">
              <div className="d-flex flex-column align-items-center text-center p-3 py-5">
                ...
                <span className="rating-profileDetails">Rating: {getStarRating(profileData.rating)}</span>
              </div>
            </div>
